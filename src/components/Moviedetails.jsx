...
import { asyncloader } from "../store/actions/movieActions";
import {
  Link,
  Outlet,
  useLocation,
  ...
  return info ? (
    <div className="w-full h-fit relative bg-black">
      ...
      <div className=" absolute top-0 left-0 h-full w-full bg-gradient-to-b from-transparent to-[#000000ad] overflow-y-auto">
        ...
        <h1 className="text-white ml-5 sm:ml-10 text-3xl font-[mori]">
          {info.recommendations.length > 0 && "Similar Movies"}
        </h1>
        <div className=" overflow-x-auto flex gap-3 mt-5 px-5 sm:px-10 py-2">
